...
void autonomous( void ) {
  ...
  lift.setVelocity(50, vex::percentUnits::pct);
  goStraight(2 * 23.5, vex::directionType::fwd, 0, 80);
  ...
  goStraight(1.1 * 23.5, vex::directionType::rev, 0, 80);
  makeTurn(180, true, 50);
  frontintake.stop();
  frontintake.spinFor(vex::directionType::fwd, 90, vex::rotationUnits::deg, 40, vex::velocityUnits::pct);
  lift.spinFor(vex::directionType::fwd, 300, vex::rotationUnits::deg);
  makeTurn(105, false, 50);
  dt.driveFor(vex::directionType::fwd, 23.5, vex::distanceUnits::in, 70, vex::velocityUnits::pct, false);
  vex::task::sleep(1000);
  frontintake.spinFor(vex::directionType::rev, 120, vex::rotationUnits::deg, true);
